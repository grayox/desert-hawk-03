...
#   $ git remote set-url origin https://github.com/grayox/desert-hawk-03  # corrects remote location if necessary
#     - or -
...
#         $ git clone https://github.com/grayox/desert-hawk-03.git
#         -OR-
